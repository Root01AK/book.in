...
export default function BookingFlow() {
  ...
  const validate = (s: number) => {
    ...
    if (s === 3) {
      ...
      if (form.description.trim().length < 20) e.description = 'Minimum 20 characters'
        ...
        <div className={`form-step${step === 1 ? ' form-step--active' : ''}`}>
          ...
          <div className="service-selector">
              ...
              return (
                ...
                >
                  ...
                  <span className="service-option__price">
                    {s.startingPrice}{s.priceNote && <><br/><small>{s.priceNote}</small></>}
                  </span>
                </button>
              )
            })}
            ...
            >
              ...
              <span className="service-option__price">₹2,00,000+</span>
            </button>
          </div>
            ...
            <div className="choice-grid-3">
              {PRIORITY_OPTIONS.map(p => (
                <button key={p.value} type="button"
                  className={`choice-btn${form.priority === p.value ? ' choice-btn--selected' : ''}`}
